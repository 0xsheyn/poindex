...
/// @title Wrapped OPN
/// @notice WETH9-style wrapper for the native OPN gas token, required by the
///         AMM router to route native <-> ERC-20 swaps. 1 WOPN is always
///         redeemable 1:1 for 1 OPN.
contract WOPN {
    ...
    function withdraw(uint256 wad) public {
        ...
        require(success, "WOPN: WITHDRAW_FAILED");
